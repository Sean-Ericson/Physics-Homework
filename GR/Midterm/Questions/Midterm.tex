...
\[ \dd s^2 = -\left(1 - \frac{2M}{\sqrt{r^2 + b^2}}\right)\dd t^2 + \left(1 - \frac{2M}{\sqrt{r^2 + b^2}}\right)\dd r^2 + (r^2 + b^2)(\dd\theta^2 + \sin^2\theta\dd\theta) \]
...
\begin{enumerate}
    ...
    \item (15 points) Write down the non-zero Christoffel symbols $\chrissym{\alpha}{\beta}{\gamma}$ for this metric. (Hint: of the 40 Christoffel symbols that are distinct by taking account of antisymmetry under $\beta \leftrightarrow \gamma$, only 9 are non-zero.)
