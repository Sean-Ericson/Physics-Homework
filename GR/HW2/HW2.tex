...
\begin{enumerate}[label=(\alph*)]
    ...
    \[ A^\mu = (t', 0, 0, 0), \quad B^\mu = (t, x, y, z) \quad (x^2 + y^2 + z^2 = t^2), \] with both $t$ and $t'$ nonzero. Assume for the sake of contradiction that their inner product is vanishes. Then,
    \begin{alignat*}{3}
        &          & A^\mu B_\mu = 0 \\
        &\implies  & tt' = 0,
    \end{alignat*}
