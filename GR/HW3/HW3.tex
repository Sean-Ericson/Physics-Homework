...
\begin{enumerate}[label=(\alph*)]
    ...
    \[ u\cdot u = R^2\left(\dot{\theta}^2 + \sin^2\theta\dot{\phi}^2\right) = 1 \implies \dot{\theta}^2 = \frac{1}{R^2}\left(1 - \frac{L^2}{R^2\sin^2\theta}\right) \implies \dot{\theta} = \frac{1}{R}\sqrt{1 - \frac{L^2}{R^2\sin^2\theta}} \]
    \[ \dv{\theta}{s} = \frac{1}{R}\sqrt{1 - \frac{L^2}{R^2\sin^2\theta}} \implies \int\dd s = \int \frac{R\dd\theta}{\sqrt{1 - \frac{L^2}{R^2\sin^2\theta}}} \]
    \item
    \[ z = R\cos\theta \implies \dd z = -R\sin\theta\dd\theta \]
    \begin{align*}
        s &= \int \frac{R\dd\theta}{\sqrt{1 - \frac{L^2}{R^2\sin^2\theta}}} \\
        &= -\int\frac{R\dd z}{\sqrt{R^2\sin^2\theta - L^2}} \\
        &= -\int\frac{R\dd z}{\sqrt{R^2\left(1 - \cos^2\theta\right) - L^2}} \\
        &= -\int\frac{R\dd z}{\sqrt{R^2 - L^2 - z^2}} \\
        &= \frac{-1}{\sqrt{R^2-L^2}}\int\frac{R\dd z}{\sqrt{1 - \frac{z^2}{R^2 - L^2}}} \\
        &= R\cos^{-1}\left(\frac{z}{\sqrt{R^2 - L^2}}\right) + C \\
        &= R\cos^{-1}\left(\frac{\sin I \cos\psi}{1 - \cos^2I}\right) + C \\
        &= R\cos^{-1}\left(\frac{\cos\psi}{\sin I}\right) + C \\
        \implies \qquad \frac{\cos\psi}{\sin I} &= \cos{\frac{s - C}{R}}
    \end{align*}
