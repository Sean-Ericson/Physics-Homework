...
\begin{enumerate}[label=\roman*.]
    ...
    \[ \frac{1}{\sqrt{2}}\mqty(x_1(t) + x_2(t) \\ x_1(t) - x_2(t)), \]
    which we recognize as being (proportional to) our two modes! Now, since both
    \[ -a \leq x_1(t) \leq a \]
    and 
    \[ -a \leq x_2(t) \leq a, \]
    we know that our configuration vector is confined to a square. Some combination of these facts leads us to conclude that the curves are bounded by square with vertices at $(a, 0)$, $(0, a)$, $(-a, 0)$, $(0, -a)$. \\
...
\begin{enumerate}[label=\roman*.]
    ...
    \[ \det[K - \omega^2M] = 0 \]
    and solve for $\omega$. Using Mathematica, we find
