...
\end{align*}
Therefore
\[ \tens{\zeta}(\omega) - \tens{\chi}_0 = \frac{1}{\pi i}\fulldashintd{\omega'}\frac{\tens{\zeta}(\omega') - \tens{\chi}_0}{\omega' - \omega} + \frac{i\sigma_0}{\omega} \]
...
\begin{enumerate}[label=(\alph*)]
    ...
    \[ \implies g(\omega, t') = \frac{e^{i\omega t'}}{-\omega^2 - i\gamma\omega + \omega_0^2} \]
    ...
    \item
    \begin{align*}
        \tilde{x}(\omega)e^{-i\omega t} &= \frac{1}{\tilde{\omega}}\cintd{0}{\infty}{t'}e^{-\gamma(t-t')/2}\sin[\tilde{\omega}(t-t')]e^{-i\omega t'}
    \end{align*}
