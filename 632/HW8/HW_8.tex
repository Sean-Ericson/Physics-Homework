...
\begin{align*}
    ...
    &= \frac{1}{\sqrt{\pi}}\frac{1 - \e^{-1}}{\sqrt{1 - \e^{-2}}}\exp\left[\frac{2xx'}{\e^{1} - \e^{-1}} - (x^2 + (x')^2)\left(\frac{\e^{-1}}{\e^1 - \e^{-1}} + \frac{1}{2}\right)\right] \\
    &= \frac{1}{\sqrt{\pi}}\frac{1 - \e^{-1}}{\sqrt{1 - \e^{-2}}}\exp[xx'\csch(\beta\hbar\omega) - \frac{1}{2}(x^2 + (x')^2)\coth(\beta\hbar\omega)]
\end{align*}
