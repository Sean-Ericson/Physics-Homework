...
\begin{enumerate}[label=(\alph*)]
    ...
    \[ UPU^\dag = \mqty(\frac{1}{2}(\cos\beta - 1)e^{i\alpha}e^{-i\gamma} & \frac{1}{\sqrt{2}}\sin\beta e^{-i\gamma} & -\frac{1}{2}(1 + \cos\beta)e^{-i\alpha}e^{-i\gamma} \\ -\frac{1}{\sqrt{2}}\sin\beta e^{i\alpha} & \cos\beta & \frac{1}{\sqrt{2}}\sin\beta e^{-i\alpha} \\ -\frac{1}{2}(\cos\beta + 1)e^{i\alpha}e^{i\gamma} & -\frac{1}{\sqrt{2}}\sin\beta e^{i\gamma} & \frac{1}{2}(\cos\beta - 1)e^{-i\alpha}e^{i\gamma}) \]
