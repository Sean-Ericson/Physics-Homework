...
\[ \psi_\text{WKB} = \begin{cases}
    ...
    \frac{A_>}{\sqrt{p(x)}}\cos\left(\frac{1}{\hbar}\cint{x}{x_1}p(x')\dd x'\right) + \frac{B_>}{\sqrt{p(x)}}\sin\left(\cint{x}{x_1}p(x')\dd x'\right) & x \gtrsim x_2
\end{cases} \]
...
We can write the left-transmission region as a superposition of left and right going waves:
\[ \psi_\text{WKB} = \frac{A_< - iB_<}{2}\exp\left[\frac{1}{\hbar}\cint{x}{x_1}\abs{p(x')}\dd x'\right] + \frac{A_< + iB_<}{2}\exp\left[-\frac{1}{\hbar}\cint{x}{x_1}\abs{p(x')}\dd x'\right] \quad x \lesssim x_1  \]
